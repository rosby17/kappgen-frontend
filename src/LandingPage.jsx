    ...
    <div className="landing-shell">
      ...
      <main>
        ...
        <section className="section faq" id="faq"><div><div className="section-kicker">QUESTIONS FRÉQUENTES</div><h2>Avant d’activer<br />KappGen.</h2></div><div className="faq-list">{[
          ['Dois-je fournir les idées ou les scripts ?', 'Tu as le choix. En mode manuel, tu peux soumettre ton script complet ou un fichier audio à transformer en vidéo. En mode automatique, tu peux donner une idée très vague ou un sujet incomplet : KappGen AI recherche alors les informations utiles, complète l’angle et rédige le script adapté à ta chaîne. Pour les niches liées à l’actualité et aux tendances, tu peux aussi activer la recherche web.'],
          ['Dois-je valider chaque vidéo ?', 'Tu as le choix : tu peux valider chaque vidéo manuellement avant de la télécharger ou de la publier, ou laisser KappGen aller jusqu’à la publication automatique sans validation manuelle. Dans les deux cas, tu gardes une vue complète sur l’activité de ta chaîne.'],
